...
```bash
python main.py reference add test_reference_1.jpg john_doe --metadata '{"name": "John Doe", "document_id": "DOC001", "consent": "yes", "source": "test_document"}'
python main.py reference add test_reference_2.jpg jane_smith --metadata '{"name": "Jane Smith", "document_id": "DOC002", "consent": "yes", "source": "test_photo"}'
```

### Test Detection
```bash
python main.py detect test_reference_1.jpg
python main.py detect test_reference_4.jpg  # Should detect multiple faces
```

### Test Verification
```bash
python main.py verify test_reference_1.jpg  # Should match reference 1
python main.py verify test_reference_3.jpg  # Should match reference 3
```
